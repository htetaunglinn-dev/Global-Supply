                  ...
                  <div className='max-w-sm bg-white w-72 h-[430px] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 '>
                    <div className='p-2 h-52'>
                      <img
                        ...
                        src='https://images.pexels.com/photos/3186949/pexels-photo-3186949.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
                        alt=''
                      />
                    </div>
                    ...
                    <div className='p-2'>
                      ...
                      <p className='mb-4 text-sm text-gray-500 tracking-tight'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Quisquam maxime corrupti voluptate dolores fugit ipsam
                        rerum temporibus omnis debitis labo.
                      </p>
