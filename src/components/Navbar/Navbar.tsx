...
const Navbar = () => {
  ...
  return (
      <nav className='absolute z-50 top-0 right-[5%] left-0 pl-5 pr-10 py-3 bg-white/50 backdrop:blur-lg' >
        <div className='flex justify-between items-center'>
          <img src={logo} alt="company logo" className='w-20 '/>

          <section className='flex items-center gap-3 text-black'>
            <p>+65 8810 5141</p>
            <a href="https://wa.me/6588105141" className='inline-block rounded border border-black/40 py-2 px-4'>Contact Me</a>
          </section>
        </div>
